...
public:
    int minimumPairRemoval(vector<int>& nums) {
        ...
        // Doubly linked list to track neighbors
        ...
        // Min-heap to store (sum, index of the left element of the pair)
        ...
        while (inversions > 0) {
            ...
            // Lazy deletion: skip if this pair is no longer valid
